...
var _$years = 3;
var johnMark = 'John an Mark';
 // var delete = 23; Do not use function names in naming variables
*/
...
var marksBMI = marksMas / (marksHeight ** 2);
console.log(marksBMI);

var johnsBMI = jOhnMass / (johnsHeight * johnsHeight);
console.log(johnsBMI);

var hasMarkHigherBmi = marksBMI > johnsBMI;
...
switch (job) {
    case 'teacher':
    case 'instructor':
        console.log(firstName + ' teaches the kid how to code.');
        break;
    case 'driver':
...
if (mikeAverage > johnAverage) {
    console.log('Mike\'s team wins with ' + mikeAverage + ' scores.')
} else if (johnAverage > mikeAverage) {
    console.log('John\'s team wins with ' + johnAverage + ' scores.')
} else {
    console.log('There is a draw.')
}


if (mikeAverage > maryAverage && mikeAverage > johnAverage) {
    console.log('Mike\'s team wins with ' + mikeAverage + ' scores.')
} else if (johnAverage > mikeAverage && johnAverage > maryAverage) {
    console.log('John\'s team wins with ' + johnAverage + ' scores.')
} else if (maryAverage > mikeAverage && maryAverage > johnAverage) {
    console.log('Mary\'s team wins with ' + maryAverage + ' scores.')
} else {
    console.log('There is a draw.')
}
...
console.log(ageJane, ageMark, ageMark);
...
john.unshift('Mr.'); // add element  in the start of the array
console.log(john);

john.pop(); // removes element from the end of the array
john.shift(); // removes element from the start of the array
console.log(john);
...
var john = {
    ...
    if (john.calcBmi() > mark.calcBmi()) {
        ...
        console.log('Their BMI are equal.' + john.bmi + ' = ' + mark.bmi)
    }
 */
...
4. As an output,
 create 1) a new array containing all tips, and
...
var john = {
    ...
    calcTips: function tipCalculator() {
        this.tips = [];
        this.finalValues = [];
...
if (john.average > mark.average){
    console.log(john.fullName +
        '\s family pays higher tips, with an average of ' + john.average +
        ' Dollars.')
}else{
